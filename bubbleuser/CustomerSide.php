  ...
  <main>
    <div class="sidebar">
      ...
      <nav class="nav flex-column">
        ...
        <a class="nav-link" href="#">
          <div class="nav-item-content">
            <img src="Heart.svg" alt="Heart"> Favorite
          </div>
        </a>
        <a class="nav-link" href="#">
          <div class="nav-item-content">
            <img src="Clock.svg" alt="Clock"> Order History
          </div>
        </a>
        <a class="nav-link" href="#">
          <div class="nav-item-content">
    ...
    <div class="header">
      ...
      <div class="bubblebop-category">
        ...
        <div class="categories">
          <div class="category-item milktea">
            <div class="category-icon"></div>
            <div class="category-text">Milktea</div>
          </div>
          <div class="category-item fruit-tea">
            <div class="category-icon"></div>
            <div class="category-text">Fruit Tea</div>
          </div>
          <div class="category-item sweets">
            <div class="category-icon"></div>
            <div class="category-text">Sweets</div>
          </div>
          <div class="category-item snacks">
            <div class="category-icon"></div>
      ...
      <!-- New Popular Milktea section -->
      
      
      <div class="popular-milktea">
        <div class="category-header d-flex justify-content-between">
          <h2>Best Picks</h2>
          <a href="#" class="view-more d-flex align-items-center gap-2">
            <span>View More</span>
        ...
        <div class="d-flex justify-content-between">
          <div class="milktea-item position-relative">
            <div class="milktea-rectangle d-flex flex-column justify-content-between">
              <img src="discount-banner.svg" alt="Discount" class="discount-banners">
              <div class="rating ">
                <img src="star.svg" alt="Star">
                <span>4.5</span>
              </div>
            </div>
            <div class="milktea-info d-flex justify-content-between align-items-center">
              <span>Boppy Cappucino Latte</span>
              <div class="price-rectangle">$14.45</div>
            </div>
          </div>
          <div class="milktea-item position-relative">
            <div class="milktea-rectangle d-flex flex-column justify-content-between">
          ...
          <div class="milktea-item position-relative">
            ...
            <div class="milktea-info d-flex justify-content-between align-items-center">
              <span>Boppy Yakult Delight</span>
              <div class="price-rectangle">$14.45</div>
            </div>
          </div>
        </div>
