...
<body>
    <div class="sidebar d-flex flex-column">
        ...
        <nav class="nav flex-column">
            ...
            <a class="nav-link active" href="order_management.php"><img src="Test Results.svg" alt="Inventory Icon">Order Management</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php elseif ($row['status'] === 'Preparing'): ?>
                                            <span class="badge bg-primary text-white">Preparing</span>
                                        <?php elseif ($row['status'] === 'Order Delivered'): ?>
                                            <span class="badge bg-success text-white">Order Delivered</span>
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td>
                                        <form method="POST" class="d-flex align-items-center">
                                            ...
                                            <select name="status" class="form-select form-select-sm" style="width: auto;">
                                                ...
                                                <option value="Order Delivered" <?= $row['status'] === 'Order Delivered' ? 'selected' : '' ?>>Order Delivered</option>
                                            </select>
